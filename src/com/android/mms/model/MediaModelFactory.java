...
public class MediaModelFactory {
    ...
    private static MediaModel getGenericMediaModel(Context context,
        ...
        if (tag.equals(SmilHelper.ELEMENT_TAG_TEXT)) {
            ...
            /**
             *  Caused by the SMIL doesn't support the tag named as 'vcard', but maybe someone will use it
             *  to share the vcard, so we need to deal with the tag contains 'vcard'.
             */
