 ...
 */
public class MessageContentScrollView extends FrameLayout {
    static final String TAG = "MessageContentScrollView";
    ...
    private View.OnClickListener mNextListener, mPrevListener, mControl;
    private Context mContext;
    private static final int HORIZONTAL_SCROLL_THRESHOLD = 50;
    private static final int VERTRAL_SCROLL_THRESHOLD = 50;   
    ...
    public MessageContentScrollView(Context context) {
        this(context, null);
    }

    public MessageContentScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.scrollViewStyle);
    }

    public MessageContentScrollView(Context context, AttributeSet attrs, int defStyle) {
