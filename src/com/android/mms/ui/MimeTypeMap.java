...
public /* package */ class MimeTypeMap {
    ...
    public static MimeTypeMap getSingleton() {
        if (sMimeTypeMap == null) {
            ...
            sMimeTypeMap.loadEntry(
                    "application/x-webarchive", "webarchive", false);  
            ...
            sMimeTypeMap.loadEntry("audio/mp3", "mp3", false);
            ...
            sMimeTypeMap.loadEntry("audio/amr", "amr", false);  
            ...
            sMimeTypeMap.loadEntry("video/3gpp", "3gpp", false);          
            ...
            sMimeTypeMap.loadEntry("text/vnd.sun.j2me.app-descriptor", "jad", false);
            sMimeTypeMap.loadEntry("application/octet-stream", "bin", false);
            sMimeTypeMap.loadEntry("application/java-archive", "jar", false);
            sMimeTypeMap.loadEntry("audio/aac", "aac", false);
            sMimeTypeMap.loadEntry("text/xml", "xml", false);
            sMimeTypeMap.loadEntry("application/xml", "xml", false);
            sMimeTypeMap.loadEntry("application/rss+xml", "rss", false);
            sMimeTypeMap.loadEntry("application/atom+xml", "atom", false);
        }
