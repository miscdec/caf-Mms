...
{
    public static final String FROM_SEARCH_ACTIVITY = "SearchActivity";
    ...
    public static final String QUERY_MMS = "com.android.search.QUERY_MMS";
    ...
    public void onCreate(Bundle icicle) {
            ...
            Thread t = new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        onClickIntent.putExtra("from", FROM_SEARCH_ACTIVITY);
        ...
        IntentFilter filter = new IntentFilter(QUERY_MMS);
